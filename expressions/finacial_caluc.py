...
print(f"at this time you can spend ${utilites} or {round (utilities_per, 2)}% on rent.")
...
print(f"at this time you can spend ${transportation} or {round (transportation_per, 2)}% on rent.")
#tell user catagory spending amount and percent for groceries ("you spend $XX.XX on groceries and that is xx% of your income")
print(f"at this time you can spend ${groceries} or {round (groceries_per, 2)}% on rent.")
...
print(f"at this time you can spend ${Spending_money} or {round (spending_money_per, 2)}% on rent.")